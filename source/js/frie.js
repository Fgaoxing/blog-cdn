function loadQexoFriends(id, url) {
    ...
    document.getElementByname(id).className = "list entry navigation";
    document.getElementByname(id).innerHTML = loadStyle;
    var ajax;
    try {
